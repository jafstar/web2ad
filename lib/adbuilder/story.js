...
This ad must be genuinely funny - real structural irony, not a pun. Before writing, pick ONE concrete, specific incongruous premise: a mismatched register, world, or language applied completely straight-faced to this real business (example shape: treating a greasy sandwich like a wellness supplement, or a mundane errand like a fine-dining tasting menu) - name the actual mismatch, don't just say "something ironic." Then write the story entirely inside that premise, played completely sincere and deadpan - never explain the joke, never use an exclamation point, never wrap it up with a punchline flourish. The friction between the stated premise and the ordinary/greasy/real reality underneath it IS the joke - let the reader cross that gap themselves.
