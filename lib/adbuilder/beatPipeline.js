...
export async function previewFirstBeat(brief) {
...
export async function buildBeatAd(runId, brief, precomputed = null) {
  ...
  return { ...result, atmosphere, beats: beats.map((b) => ({ id: b.id, phrase: b.phrase, visual: b.visual, targetDuration: b.targetDuration, narrationStart: b.narrationStart, keyframeUrl: b.keyframeUrl })) }
}
