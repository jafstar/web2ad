...
//
// Bumped from gemini-2.5-flash to the real Pro-tier model live 2026-07-28,
// confirmed available on this account by querying the API's own model
// list directly (not guessed from docs) - creative writing quality was
// the one identified remaining weak point, and unlike the image/video
// generation calls, a stronger text model here costs almost nothing extra
// per call.
